// $ANTLR 3.5 ../src/Expr.g 2015-09-16 09:42:39
...
public class ExprParser extends Parser {
	...
	// $ANTLR start "prog"
	// ../src/Expr.g:12:1: prog : ( stat )+ ;
	public final void prog() throws RecognitionException {
		try {
			// ../src/Expr.g:12:5: ( ( stat )+ )
			// ../src/Expr.g:12:9: ( stat )+
			{
			// ../src/Expr.g:12:9: ( stat )+
			int cnt1=0;
			loop1:
	...
	// $ANTLR start "stat"
	// ../src/Expr.g:14:1: stat : ( expr NEWLINE | ID '=' expr NEWLINE | NEWLINE );
	public final void stat() throws RecognitionException {
		...
		try {
			// ../src/Expr.g:14:5: ( expr NEWLINE | ID '=' expr NEWLINE | NEWLINE )
			int alt2=3;
			switch ( input.LA(1) ) {
			case INT:
			case 8:
			...
			switch (alt2) {
				case 1 :
					...
					break;
				case 2 :
					// ../src/Expr.g:15:9: ID '=' expr NEWLINE
					{
	...
	// $ANTLR start "expr"
	// ../src/Expr.g:20:1: expr returns [int value] : e= multExpr ( '+' e= multExpr | '-' e= multExpr )* ;
	public final int expr() throws RecognitionException {
		...
		try {
			// ../src/Expr.g:21:5: (e= multExpr ( '+' e= multExpr | '-' e= multExpr )* )
			// ../src/Expr.g:21:9: e= multExpr ( '+' e= multExpr | '-' e= multExpr )*
			{
			...
			value = e;
			// ../src/Expr.g:22:9: ( '+' e= multExpr | '-' e= multExpr )*
			loop3:
			while (true) {
				int alt3=3;
	...
	// ../src/Expr.g:27:1: multExpr returns [int value] : e= atom ( '*' e= atom )* ;
	public final int multExpr() throws RecognitionException {
		...
		try {
			// ../src/Expr.g:28:5: (e= atom ( '*' e= atom )* )
			// ../src/Expr.g:28:9: e= atom ( '*' e= atom )*
			{
	...
	// $ANTLR start "atom"
	// ../src/Expr.g:31:1: atom returns [int value] : ( INT | ID | '(' expr ')' );
